...
function StudentDashboard() {
  ...
  const progressCount = complaints.filter(
    (complaint) => String(complaint.status || "").toLowerCase() === "in progress"
  ).length;
  ...
  const handleSubmitComplaint = (event) => {
    ...
    try {
      ...
      setComplaints((previous) => [createdComplaint, ...previous]);
      setNewComplaint({
        title: "",
        category: "Infrastructure",
        priority: "Medium",
  ...
  const getComplaintTitle = (complaint) => {
    return complaint.title || complaint.subject || "Untitled Complaint";
  };
  ...
  const getPriorityClass = (priority) => {
    const cleanPriority = String(priority || "").toLowerCase().replace(/\s+/g, "-");
      ...
      <div className="dashboard-layout">
        <aside className="sidebar">
          ...
          <nav className="sidebar-menu">
            ...
            <a href="#my-feedbacks">My Feedbacks</a>
        ...
        <main className="dashboard-content">
          <header className="dashboard-header" id="overview">
            <div>
              <span className="dashboard-eyebrow">CAMPUSVOICE STUDENT PORTAL</span>
              <h1>Student Dashboard</h1>
              <p>
                Welcome back, {displayName}. Track your complaints, feedback,
                and campus concerns.
              </p>
            </div>
          ...
          <div className="dashboard-split-row">
            <section className="dashboard-section split-col" id="my-complaints">
              <div className="section-heading-row">
                <div>
                  <span className="section-eyebrow">COMPLAINT MANAGEMENT</span>
                  <h2>My Complaints</h2>
                  <p>View and track the complaints you have submitted.</p>
                </div>

                <Link to="/track-complaint" className="section-link">
                  Track Complaint
                </Link>
              </div>
                        ...
                        <tr key={complaint.id}>
                          ...
                          <td>
                            <div className="complaint-title-cell">
                              <span>{getComplaintTitle(complaint)}</span>
            ...
            <section className="dashboard-section split-col" id="my-feedbacks">
              <div className="section-heading-row">
                <div>
                  <span className="section-eyebrow">FEEDBACK MANAGEMENT</span>
                  <h2>My Feedbacks</h2>
                  <p>Review the feedback you have submitted through CampusVoice.</p>
                </div>
              ...
              {sortedFeedbacks.length === 0 ? (
                <div className="empty-state">
                  ...
                  <Link to="/feedback" className="empty-state-btn">
                    Submit Feedback
                  </Link>
                </div>
              ) : (
                    ...
                    <article className="feedback-card" key={feedback.id}>
                      <div className="feedback-card-header">
                        <div>
                          ...
                          <h3>{feedback.category || "General"}</h3>
                        </div>
                      ...
                      <div className="feedback-card-footer">
                        ...
                        <span>{feedback.id || "Feedback"}</span>
                      </div>
                    </article>
                  ))}
                </div>
          ...
          <section className="profile-preview-section">
            <div className="profile-preview-content">
              <span className="section-eyebrow">STUDENT ACCOUNT</span>
              <h2>Your Profile</h2>
              <p>
                View the personal, contact, student, and account information
                submitted during registration.
              </p>
            </div>

            <Link to="/profile" className="profile-preview-btn">
              View My Profile
            </Link>
          </section>
          ...
          <section className="manage-section">
            <div className="manage-content">
              <span className="section-eyebrow">CAMPUSVOICE SERVICES</span>
              <h2>Manage Your Campus Concerns</h2>
              <p>
                Submit complaints, track existing issues, and share anonymous
            ...
            <div className="manage-actions">
              ...
              <Link to="/track-complaint" className="manage-action">
                Track Complaint
              </Link>

              <Link to="/feedback" className="manage-action">
                Anonymous Feedback
              </Link>
            </div>
          </section>
        ...
        >
          <div className="modal-body">
            <div className="modal-header">
              <div>
                <span className="modal-eyebrow">CAMPUSVOICE</span>
                <h2>Submit New Complaint</h2>
                <p>
                  Provide the details of the issue you would like the
